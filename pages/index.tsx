        ...
        <div className="container py-3 py-md-5">
          <div className="row">
            <div className="text-part text-center text-md-start col-12 col-lg-4">
              <h2>Who I am</h2>
              <p>
                I&apos;ve been a UX and UI designer for over 5 years, a web
                development enthusiast and passionate about problem solving
                (physics or not).
              </p>
              <p>
                I&apos;m also learning and sharing educational subjects on my{' '}
              ...
              <Link href="/about">
                <a className="btn-red btn-blue-transparent w-100 my-3">
                  More about me
                </a>
              </Link>
            </div>
            <div className="pics d-flex justify-content-center align-center col-12 col-lg-8">
              <div className="text-part col">
                ...
                <div className="pb-3 ">
                  <Image
                    className="img-fluid mx-auto pe-1 p-md-2 floating-2"
                    src={aDev}
              ...
              <div className="text-part col">
                ...
                <div className="pb-3">
                  <Image
                    className="img-fluid mx-auto ps-1 p-md-2 floating-3"
                    src={aEdu}
                    alt="Education icon"
                  />
                </div>
