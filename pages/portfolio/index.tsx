    ...
    <div className="row flex-column flex-md-row">
      <div className="col-md-6">
        <div className="py-2 d-flex align-items-center justify-content-between w-100">
          <span className="circSpanBloom circSpanBloom-red col-4 mx-auto">1</span>
          <div className="textArea col-8">
            <h3>🔍 Research</h3>
            <p>The first stage when I start some new project is doing researches with potential users, looking for some <span className="p-red">similar projects</span>, note technologies and pre set possible structures.</p>
          </div>
        </div>
        <div className="py-2 d-flex align-items-center justify-content-between w-100">
          <span className="circSpanUp circSpan-blue col-4 mx-auto">2</span>
          <div className="textArea col-8">
            <h3>💡 Concept</h3>
            <p>After brainstorming, it&apos;s time to write all design concepts, do guidelines, and <span className="p-blue">flowchart</span> the user interactivity.</p>
          </div>
        </div>
        <div className="py-2 d-flex align-items-center justify-content-between w-100">
          <span className="circSpanUp circSpan-green col-4 mx-auto">3</span>
          <div className="textArea col-8">
            <h3>🔨 Develop</h3>
